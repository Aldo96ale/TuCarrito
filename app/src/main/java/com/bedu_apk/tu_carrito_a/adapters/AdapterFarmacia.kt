...
class AdapterFarmacia (
...
) : RecyclerView.Adapter<AdapterFarmacia.ViewHolder>()  {   //modificar ponerle el mismo nombre del adaptador
    ...
    class ViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(product: ListModel, context: Context) {  //Nombre del modelo
            productName.text = product.titulo
            description.text = product.categoria
            price.text = product.price
            image.setImageResource(product.idPortrait)
