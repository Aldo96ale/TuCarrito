...
import com.bedu_apk.tu_carrito_a.models.Contacts

class AdapterContats (
    var context: Context,
    var contacts: MutableList<Contacts>): RecyclerView.Adapter<AdapterContats.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(contact: Contacts, context: Context){
